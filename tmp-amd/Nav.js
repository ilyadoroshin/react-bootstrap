define(["exports", "module", "react", "./utils/joinClasses", "./BootstrapMixin", "./CollapsableMixin", "./utils/classSet", "./utils/domUtils", "./utils/cloneWithProps", "./utils/ValidComponentChildren", "./utils/createChainedFunction"], function (exports, module, _react, _utilsJoinClasses, _BootstrapMixin, _CollapsableMixin, _utilsClassSet, _utilsDomUtils, _utilsCloneWithProps, _utilsValidComponentChildren, _utilsCreateChainedFunction) {
  "use strict";
  ...
  var Nav = React.createClass({
    ...
    renderUl: function renderUl() {
      ...
      return React.createElement(
        "ul",
        _extends({}, this.props, { className: joinClasses(this.props.className, classSet(classes)), ref: "ul" }),
