define(["exports", "module", "react", "./utils/joinClasses", "./utils/classSet", "./Button"], function (exports, module, _react, _utilsJoinClasses, _utilsClassSet, _Button) {
  "use strict";
  ...
  var Input = React.createClass({
      ...
      switch (this.props.type) {
        case "select":
          input = React.createElement(
            "select",
            _extends({}, this.props, { className: joinClasses(this.props.className, "form-control"), ref: "input", key: "input" }),
            this.props.children
          );
          break;
        case "textarea":
          input = React.createElement("textarea", _extends({}, this.props, { className: joinClasses(this.props.className, "form-control"), ref: "input", key: "input" }));
          break;
        case "static":
          input = React.createElement(
            "p",
            _extends({}, this.props, { className: joinClasses(this.props.className, "form-control-static"), ref: "input", key: "input" }),
            this.props.value
          );
          break;
        case "submit":
        ...
        default:
          ...
          input = React.createElement("input", _extends({}, this.props, { className: joinClasses(this.props.className, className), ref: "input", key: "input" }));
      }
    ...
    renderInputGroup: function renderInputGroup(children) {
      ...
      return addonBefore || addonAfter || buttonBefore || buttonAfter ? React.createElement(
        "div",
        { className: joinClasses(inputGroupClassName, "input-group"), key: "input-group" },
        addonBefore,
        buttonBefore,
        children,
        addonAfter,
