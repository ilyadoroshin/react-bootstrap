define(["exports", "module", "react", "./utils/joinClasses", "./Interpolate", "./BootstrapMixin", "./utils/classSet", "./utils/cloneWithProps", "./utils/ValidComponentChildren"], function (exports, module, _react, _utilsJoinClasses, _Interpolate, _BootstrapMixin, _utilsClassSet, _utilsCloneWithProps, _utilsValidComponentChildren) {
  "use strict";
  ...
  var ProgressBar = React.createClass({
    ...
    renderProgressBar: function renderProgressBar() {
      ...
      return React.createElement(
        "div",
        _extends({}, this.props, { className: joinClasses(this.props.className, classSet(classes)), role: "progressbar",
